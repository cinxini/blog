...
<template>
    <v-sheet class="main-background">
        <div>
            <v-chip label variant="outlined" density="comfortable" size="small" color="secondary-lighten-3">{{ meta.category }}</v-chip>
        </div>
        ...
        <FlexBox class="my-1">
            ...
            <v-icon icon="fa-solid fa-tag" size="x-small" color="secondary-lighten-3"></v-icon>
            <FlexBox class="ga-1">
